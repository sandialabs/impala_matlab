classdef ModelmvBayes_warp_mf < handle
    ...
    methods
        function obj = ModelmvBayes_warp_mf(bmod, bmod_corr, input_names, exp_ind, s2)
            % **PCA Based Model Emulator using mvBayes MultiFidelity Framework Phase**
            %
            % This function setups up emulator object
            %
            % bmod: a object of the type mvBayes
            % bmod_corr: a cell array of objects of the type mvBayes,
            ...
            % 
            % returns an object of class ModelmvBayes_warp_mf
            arguments
                bmod mvBayes
                bmod_corr cell
                input_names
